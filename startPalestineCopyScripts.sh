...
nohup /home/anita/Code/anitaAwareFileMaker/palestine/copyScripts/streamTDRSSdata.sh > $AWARE_OUTPUT_DIR/ANITA4/log/tdrssCopy.log 2>&1 < /dev/null &
...
nohup /home/anita/Code/anitaAwareFileMaker/palestine/copyScripts/streamLOSdata.sh > $AWARE_OUTPUT_DIR/ANITA4/log/losCopy.log 2>&1 < /dev/null &
