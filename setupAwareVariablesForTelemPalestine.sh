...
export ANITA_TREE_MAKER_DIR=/home/anita/Code/anitaTreeMaker



export AWARE_OUTPUT_DIR=/data/palestine2016/aware/output/
export ANITA_TELEM_DATA_DIR=/data/palestine2016/telem/

export AWARE_SITE_SCRIPT=${ANITA_TELEM_DIR}/startPalestineCopyScripts.sh
